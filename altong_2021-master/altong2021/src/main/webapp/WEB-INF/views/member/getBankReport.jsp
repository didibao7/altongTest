...
<c:if test="${sumAnswer != zeroDecimal}">
...
<c:if test="${sumViewA != zeroDecimal}">
...
<c:if test="${sumViewQ != zeroDecimal}">
...
<c:if test="${sumViewRQ != zeroDecimal}">
...
<c:if test="${sumViewRA != zeroDecimal}">
...
<c:if test="${sumRefund != zeroDecimal}">
...
<c:if test="${sumEvent != zeroDecimal}">
...
<c:if test="${sumWithdraw != zeroDecimal}">
...
<c:if test="${sumQuestion != zeroDecimal}">
