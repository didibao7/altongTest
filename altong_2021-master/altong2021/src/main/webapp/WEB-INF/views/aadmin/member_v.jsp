...
<c:forEach var="a" items="${aList}" varStatus="status">
	<div class="atm_myjjim_el atm_border">
		<div class="atm_myjjim_c7" onClick="javascript:location.href='/answer/answerView?AnswerSeq=${a.answerSeq}&QuestionSeq=${a.questionSeq}&CurPageName=/member/myView&Section1=${section1}';">${a.regdate} 에 열람한 답변입니다.</div><br />
		<p class="beefup__head" onClick="javascript:location.href='/answer/answerView?AnswerSeq=${a.answerSeq}&QuestionSeq=${a.questionSeq}&CurPageName=/member/myView&Section1=${section1}';"><img src="/Common/images/icon_answer.png" class="atm_icon_amark"/>${a.answer}</p>
	</div>
</c:forEach>
</div>
