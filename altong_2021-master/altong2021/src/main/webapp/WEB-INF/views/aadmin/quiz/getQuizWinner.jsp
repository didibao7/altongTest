...
<script>
function procQuizWin() {
	var uid = '${uid}';
	$.ajax({
		type: 'post',
		url: '/aadmin/procQuizWinnerAjax',
		data: {'uid' : uid},
		dataType: 'json',
		crossDomain: true,
		success: function (r) {
...
<div id="wrapper">
	...
	<div id="M_wrapper">
		...
		<div id="list">
			<p><a href="/aadmin/quiz/getQuizWinner"></a>퀴즈 우승자 : ${succssLogCount} 명 | <a href="/aadmin/quiz/getQuizReqUser?uid=${uid}">퀴즈 참가자</a></p>
...
<c:if test="${quiz.complete == 'N' and quiz.useChk == 'Y'}">
<button type="button" class="btn btn-warning btn-sm" onClick="javascript:procQuizWin();">상금알 지급 하기</button>
</c:if>
