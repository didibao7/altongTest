...
<div class="atm_rankq_tab1_pc">
	<p class="atm_rankq_tabc1" onClick="location.href='/question/bestList';">베스트 질문</p>
	<p class="atm_rankq_tabc2_on" onClick="location.href='/question/eventList'">이벤트</p>
	<p class="atm_rankq_tabc3" onClick="location.href='/question/rankQuestion';">랭킹</p>
</div>
</div>