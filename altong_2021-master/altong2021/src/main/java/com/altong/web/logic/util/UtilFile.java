...
public class UtilFile {
	...
	public String fileUpload(MultipartHttpServletRequest request,
        MultipartFile uploadFile, String subPath) {
		String path = "";
		String fileName = "";
		...
		try {
			...
			path = getSaveLocation(request, subPath);
	...
	public String getSaveLocation(MultipartHttpServletRequest request, String subPath) {
	
		String uploadPath = request.getSession().getServletContext().getRealPath("/");
		String attachPath = "UploadFile/";
		attachPath += subPath + "/";
	...
	public void deleteFile(File original) {
		//업로드 원본 파일 삭제
		if(original.delete()){
